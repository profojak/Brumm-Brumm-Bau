...
SDLWindow::SDLWindow(const WindowCreateInfo& createInfo)
{
  ...
  spdlog::info("Created Window\n\t- Title: {}\n\t- Window Size: {}\n\t- Framebuffer Size: {}", createInfo.title,
               toString(mWindowSize), toString(mFramebufferSize));
}
...
Result<void> SDLWindow::createVulkanSurfaceKHR(const vk::Instance& instance, vk::SurfaceKHR* pSurface) const noexcept
{
