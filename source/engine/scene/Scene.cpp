...
namespace ptvc
{
    ...
    void Scene::createSceneDescriptor() noexcept
    {
        ...
        for (auto i = 0; i < mDescriptor->getSetCount(); i++)
        {
            ...
            const auto dirBufferInfo = vk::DescriptorBufferInfo()
                .setBuffer(mDirectionalLight->getHandle())
                .setOffset(0)
                .setRange(mDirectionalLight->getSize());
            ...
            const auto pointBufferInfo = vk::DescriptorBufferInfo()
                .setBuffer(mPointLight->getHandle())
                .setOffset(0)
                .setRange(mPointLight->getSize());
            ...
            mVulkanContext->getDevice()->getHandle()
