...
void ArcballCamera::update(const float x, const float y, const bool isDragging, const bool isStrafing) noexcept
{
  ...
  mViewMatrix = glm::inverse(glm::translate(glm::mat4(1.0f), mPosition)) * glm::yawPitchRoll(-mYaw, -mPitch, 0.0f);
