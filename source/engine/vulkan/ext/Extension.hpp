...
def_VulkanExt(VulkanAccelerationStructureExt,
              vk::KHRAccelerationStructureExtensionName,
              vk::PhysicalDeviceAccelerationStructureFeaturesKHR,
              [&]() -> void {
                mFeatureStruct = vk::PhysicalDeviceAccelerationStructureFeaturesKHR().setAccelerationStructure(true);
              });

// VK_KHR_ray_tracing_pipeline
def_VulkanExt(VulkanRayTracingPipelineExt,
              vk::KHRRayTracingPipelineExtensionName,
              vk::PhysicalDeviceRayTracingPipelineFeaturesKHR,
              [&]() -> void {
                mFeatureStruct = vk::PhysicalDeviceRayTracingPipelineFeaturesKHR().setRayTracingPipeline(true);
              });

// VK_KHR_ray_query
def_VulkanExt(VulkanRayQueryExt, vk::KHRRayQueryExtensionName, vk::PhysicalDeviceRayQueryFeaturesKHR, [&]() -> void {
  mFeatureStruct = vk::PhysicalDeviceRayQueryFeaturesKHR().setRayQuery(true);
});

// VK_EXT_mesh_shader
def_VulkanExt(VulkanMeshShaderExt, vk::EXTMeshShaderExtensionName, vk::PhysicalDeviceMeshShaderFeaturesEXT, [&]() -> void {
  mFeatureStruct = vk::PhysicalDeviceMeshShaderFeaturesEXT().setMeshShader(true).setTaskShader(true).setMeshShaderQueries(true);
});
}  // namespace ptvc::rhi
