...
#define STYLE_BOOL(VALUE, T, F)                                                                                        \
  fmt::styled(VALUE ? T : F, fmt::fg(VALUE ? fmt::color::lawn_green : fmt::color::pale_violet_red))
...
#define exitOnError(R)                                                                                                 \
  if(!R.has_value())                                                                                                   \
  {                                                                                                                    \
    exitWithError("{}", STYLE_ERROR(R.error()));                                                                       \
  }
